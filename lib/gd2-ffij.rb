...
module GD2
  ...
  module GD2FFI
    ...
    FFI_LAYOUT = {
      ...
      :gdImageCreateFromWebp              => [ :pointer,  :pointer ],
      :gdImageCreateFromWebpPtr           => [ :pointer,  :int, :pointer ],
      ...
      :gdImageWebp                        => [ :void,     :pointer, :pointer ],
      :gdImageWebpPtr                     => [ :pointer,  :pointer, :pointer ],
